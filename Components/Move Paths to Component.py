		...
		try:
			...
			if thisFont is None:
				...
				if not thisGlyph.layers[0].paths:
					Message(title="Error: No Paths in Glyph", message="The glyph ‘%s’ seems to have no paths. So the script has nothing to turn into a component."%glyphName, OKButton="Oops")

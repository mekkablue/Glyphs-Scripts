...
class RealignStackingAnchors( object ):
	...
	def __init__( self ):
		...
		self.w.whichAnchorPairs.getNSTextField().setToolTip_("Comma-separated list of anchor names. With or without underscore does not matter. You only need to specify one of both. Example: ‘top, bottom’.")
		linePos += lineHeight

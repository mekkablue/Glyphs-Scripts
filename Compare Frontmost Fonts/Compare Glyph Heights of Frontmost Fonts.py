		...
		try:
			...
			if len(Glyphs.fonts) < 2:
				...
				if not collectedGlyphNames:
					Message(title="No significant differences", message="No differences larger than %.1f found between the two frontmost fonts. See the macro window for error messages."%tolerate, OKButton="😎 Cool")
				else:

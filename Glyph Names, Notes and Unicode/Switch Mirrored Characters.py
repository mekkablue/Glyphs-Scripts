...
# taken from http://www.unicode.org/Public/UNIDATA/BidiMirroring.txt
...
# parse BiDi info:
mirrorDict = {}
for line in bidiInfo.splitlines():
	line = line.strip()
	if line and ";" in line and not line.startswith("#"):
		if "#" in line:
			line = line[:line.find("#")].strip()
		unicode1, unicode2 = line.split(";")[:2]
		unicode1 = unicode1.strip()
		unicode2 = unicode2.strip()
		mirrorDict[unicode1] = unicode2

thisFont = Glyphs.font  # frontmost font
if thisFont.currentTab:
	mirroredText = ""
	for thisChar in thisFont.currentText:
		code = ord(thisChar)
		if code:
			hexcode = "%04X" % code
			if hexcode in mirrorDict.keys():
				mirroredGlyph = thisFont.glyphForUnicode_(mirrorDict[hexcode])
				if mirroredGlyph and mirroredGlyph.charString():
					thisChar = mirroredGlyph.charString()
		mirroredText += thisChar
	thisFont.currentText = mirroredText

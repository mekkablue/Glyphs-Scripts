...
class CompositeVariabler(mekkaObject):
	...
	def __init__(self):
		...
		self.w.processBracketLayers = vanilla.CheckBox((inset + 2, linePos - 1, windowWidth // 2, 20), "Process [BRACKET] layers", value=False, callback=self.SavePreferences, sizeStyle='small')

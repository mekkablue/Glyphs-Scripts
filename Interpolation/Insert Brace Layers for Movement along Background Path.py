		...
		for thisSegment in movePath.segments:
			...
			if len(thisSegment) == 4:
				for i in range(steps):
					if Glyphs.versionNumber >= 3:
						# Glyphs 3 code
						offsetPoint = bezier(thisSegment[0], thisSegment[1], thisSegment[2], thisSegment[3], i * 1.0 / steps)
					else:
						# Glyphs 2 code
						offsetPoint = bezier(thisSegment[0].pointValue(), thisSegment[1].pointValue(), thisSegment[2].pointValue(), thisSegment[3].pointValue(), i * 1.0 / steps)
					shiftTransform = transform(shiftX=offsetPoint.x - originPoint.x, shiftY=offsetPoint.y - originPoint.y).transformStruct()

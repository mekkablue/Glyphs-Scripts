...
if firstGlyph and secondGlyph:
	...
	Message(title="Invalid Glyph Selection", message="This script needs exactly two glyphs selected, it will use the right kerning group of the left glyph, and vice versa. Select two glyphs and try again.", OKButton=None)
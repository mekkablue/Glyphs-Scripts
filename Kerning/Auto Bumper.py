...
class Bumper( object ):
	def __init__( self ):
		...
		self.w.minDistance.getNSTextField().setToolTip_("Adds kerning if the shortest distance between two glyphs is shorter than specified value. Leave blank or set to zero to ignore.")
		...
		self.w.maxDistance.getNSTextField().setToolTip_("Adds kerning if the shortest distance between two glyphs is larger than specified value. Leave blank or set to zero to ignore.")

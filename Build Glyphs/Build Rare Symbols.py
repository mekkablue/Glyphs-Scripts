...
class BuildCirclesSquaresTriangles( object ):
	...
	def updateUI(self, sender=None):
		toggle = (
			   self.w.whiteTriangles.get()
			or self.w.blackTriangles.get()
			or self.w.black3DArrowheads.get()
			or self.w.blackArrowheads.get()
			or self.w.whiteShapes.get()
			or self.w.blackShapes.get()
			or self.w.whiteLargeSquare.get()
			or self.w.blackLargeSquare.get()
			or self.w.propellor.get()
			or self.w.viewdataSquare.get()
		)
	...
	def BuildCirclesSquaresTrianglesMain( self, sender=None ):
		try:
			...
			if thisFont is None:
				...
				if whiteTriangles:
					triangleInfo = (
						{ "name":"upWhiteTriangle",    "rotation":  0 },
						{ "name":"rightWhiteTriangle", "rotation":-90 },
						{ "name":"downWhiteTriangle",  "rotation":180 },
						{ "name":"leftWhiteTriangle",  "rotation":+90 },
					)
				...
				if blackTriangles:
					triangleInfo = (
						{ "name":"upBlackTriangle",    "rotation":  0 },
						{ "name":"rightBlackTriangle", "rotation":-90 },
						{ "name":"downBlackTriangle",  "rotation":180 },
						{ "name":"leftBlackTriangle",  "rotation":+90 },
					)
					for shape in triangleInfo:
						glyphName = shape["name"]
						rotation = shape["rotation"]
				...
				if blackArrowheads:
					triangleInfo = (
						{ "name":"blackUpEquilateralArrowhead",    "rotation":  0 },
						{ "name":"blackRightEquilateralArrowhead", "rotation":-90 },
						{ "name":"blackDownEquilateralArrowhead",  "rotation":180 },
						{ "name":"blackLeftEquilateralArrowhead",  "rotation":+90 },
					)
					for shape in triangleInfo:
						glyphName = shape["name"]
						rotation = shape["rotation"]
				...
				if black3DArrowheads:
					triangleInfo = (
						{ "name":"threeDRightLightedUpEquilateralArrowhead",  "rotation":  0 },
						{ "name":"threeDTopLightedRightEquilateralArrowhead", "rotation":-90 },
						{ "name":"threeDLeftLightedDownEquilateralArrowhead", "rotation":180 },
						{ "name":"threeDTopLightedLeftEquilateralArrowhead",  "rotation":+90 },
					)
					for shape in triangleInfo:
						glyphName = shape["name"]
						rotation = shape["rotation"]

...
parser = ArgumentParser(description="Fix Italic PS Names in fvar when they have a double ‘Italic’ signifier. Will rework the corresponding name table entries.")
